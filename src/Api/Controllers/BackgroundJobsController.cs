...
public class BackgroundJobsController : BaseApiController
{
    ...
    public ActionResult<ApiResponse<bool>> AutoGenerateInvoices() => Ok(ApiResponse<bool>.SuccessResponse(true, "Job triggered"));
    ...
    [Authorize(Roles = "PLATFORM_ADMIN")]
    public ActionResult<ApiResponse<bool>> CalculateLateFees() => Ok(ApiResponse<bool>.SuccessResponse(true, "Job triggered"));
